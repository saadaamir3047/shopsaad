...
@section('content')
    <!-- Main content -->
    <section class="content" style="margin-top: 96px!important;">
        <div class="row">
{{--            <div class="col-md-4">--}}
{{--                <h3>@lang( 'lang_v1.view_user' )</h3>--}}
{{--            </div>--}}
            <div class="col-md-4 col-xs-12 mt-15 pull-right" style="margin-left: 65%">
        ...
        <div class="row">
            <div class="col-md-3">
                <!-- Profile Image -->
                <div class="box" style="border-top-color: #7367f0;">
