...
<section class="content-header" style="margin-top: 96px !important;">
{{--    <h1>@lang( 'user.roles' )--}}
...
<section class="content">
    @component('components.widget', ['class' => 'card', 'title' => __( 'user.all_roles' )])
        @can('roles.create')
            @slot('tool')
                <div class="box-tools">
...
<script type="text/javascript">
    $(document).ready(function($){
        $('#roles_table_wrapper').removeClass('form-inline');
    });
</script>
@endsection
