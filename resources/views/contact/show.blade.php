...
<!-- Main content -->
<section class="content no-print" style="margin-top: 90px!important;">
    <div class="row no-print">
{{--        <div class="col-md-4">--}}
{{--            <h3>@lang('contact.view_contact')</h3>--}}
{{--        </div>--}}
        <div class="col-md-4 col-xs-12 mt-15" style="margin-left: 65%;">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body">
                    <hr><h3 class="text-center">@lang('contact.view_contact')</h3><hr>
