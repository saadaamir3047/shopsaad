...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-sm-3" style="margin-top: 9%;">
        ...
        @if( $contact->type == 'supplier' || $contact->type == 'both')
            ...
            <div class="col-sm-12">
                @if(($contact->total_purchase - $contact->purchase_paid) > 0)
                    <button href="{{action('TransactionPaymentController@getPayContactDue', [$contact->id])}}?type=purchase" class="pay_purchase_due btn btn-primary btn-sm pull-right"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> @lang("contact.pay_due_amount")</button>
                @endif
            </div>
        @endif
    </div>
