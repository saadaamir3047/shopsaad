...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="" style="margin-top: 90px!important;">
            <div class="content-header row">
                <h1 class="p-2">{{ __('home.welcome_message', ['name' => Session::get('user.first_name')]) }}
                </h1>
            </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card" style="padding-bottom: 10%;">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1"><span class="info-box-number total_purchase"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h2>
                                    <p class="mb-0">{{ __('home.total_purchase') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card" class="card" style="padding-bottom: 10%;">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1"><span class="info-box-number total_sell"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h2>
                                    <p class="mb-0">{{ __('home.total_sell') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card" class="card" style="padding-bottom: 10%;">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1"><span class="info-box-number purchase_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h2>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card" class="card" style="padding-bottom: 10%;">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1"><span class="info-box-number invoice_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h2>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card" class="card" style="padding-bottom: 10%;">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1"><span class="info-box-number total_expense"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h2>
                                    <p class="mb-0">{{ __('lang_v1.expense') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        @component('components.widget', ['class' => 'box-danger'])
                            ...
                            @endslot
                            <table class="table table-bordered table-striped"  class="table mb-0" id="sales_payment_dues_table">
                                <thead>
                                <tr>
